  ...
  return (
    <div className="bg-background-primary min-h-screen w-full pb-24">
      ...
      <footer className=" fixed bottom-0 left-0 right-0 flex items-center justify-center p-5 bg-background-tertiary">
        <button className="cursor-pointer w-54.5 py-2 px-5 rounded-lg bg-content-brand uppercase text-label-large font-inter hover:bg-background-highlights transition-colors duration-250 ease-in-out ">
          Novo Agendamento
        </button>
      </footer>
    </div>
